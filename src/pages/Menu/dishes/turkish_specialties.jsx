...
const TurkishSpecialitiesComponent = () => {
  const { turkish_specialties } = menu_data.menu; // Access the tacos data from the JSON
  const { title, note, data } = turkish_specialties; // Destructure note and data
  console.log(turkish_specialties);
...
export default TurkishSpecialitiesComponent;
