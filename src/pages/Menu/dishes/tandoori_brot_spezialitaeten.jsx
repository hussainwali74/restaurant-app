...
const TanduriBrotComponent = () => {
  const { tandoori_brot_spezialitaeten } = menu_data.menu; // Access the tacos data from the JSON
  const { title, note, data } = tandoori_brot_spezialitaeten; // Destructure note and data
  console.log(tandoori_brot_spezialitaeten);
...
export default TanduriBrotComponent;
